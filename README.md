...
1. Скачать себе на машину вот [этот](https://github.com/GronickWork/test-from-gronik-back) сервер.
...
4. Зайти на [эту](https://gronickwork.github.io/test-from-gronik/) страницу - и можно проверять...
